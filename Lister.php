																	...
																	<input id="df" type="date" class="form-control" name="df" tabindex="1" required autofocus>
																		 ...
																		 <div class ="row">
																			 <div class="col-lg-4"></div>
																				 <div class="col-lg-4">
                                                                                     <div class="form-group">
                                                                                         <button id="_lister" class="btn btn-info btn-lg btn-block" tabindex="4">Lister</button>
                                                                                     </div>
                                                                                 </div>
                                                                         </div>
                                                                    <div class="row text-center p-4 h1">
                                                                        <div class="col c-b text-success" style="display: none">
                                                                            <span id="c-old"></span><br/>
                                                                            <span class="h6">
                                                                                Total des infractions dans la periode selectione
                                                                            </span>
                                                                        </div>
                                                                        <div class="col c-b text-secondary align-items-center" style="display:none">
                                                                            <span id="c-new"></span> <span id="per"></span><br/>
                                                                            <span class="h6">
                                                                                Total des infractions dans la periode precedente
                                                                            </span>
                                                                        </div>
                                                                    </div>
                      ...
                      <table class="table table-striped table-bordered" id="table-1">
                        <thead>                                 
                          <tr>
                             ...
                             <th  class="th-sm">Arrondissement</th>
